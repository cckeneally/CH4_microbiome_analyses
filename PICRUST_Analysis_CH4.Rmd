---
title: "PICRUSt_Analysis_CH4"
author: "Christopher Keneally"
date: "`r Sys.Date()`"
...
opts_knit$set(root.dir = "home/chriskeneally/Documents/Postgrad/Data/PhoenixOutputs/coorong16sanalysis_2021")
```
...
To get the rep-seqs (required input for picrust2), rep-seqs.qza must be exported from qiime as follows:
...
Picrust2 can be run with with the following slurm job script from the HPC Example here is the UoA phoenix HPC, which uses slurm to schedule jobs
...
Below I've taken a step-by-step approach because I had to troubleshoot, but there is a full pipeline analysis available on github. In the following example, I'm analysing single orthologs of interest to our study on methane production.
